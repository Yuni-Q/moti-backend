...
const login_guard_1 = require("../common/guard/login.guard");
...
__decorate([
    ...
    common_1.Get(),
    openapi.ApiResponse({ status: 200, type: require("./dto/missions.dto").MissionsDto }),
...
__decorate([
    ...
    common_1.Get(':id'),
    openapi.ApiResponse({ status: 200, type: require("./dto/mission.dto").MissionDto }),
    __param(0, token_user_id_decorator_1.TokenUserId()),
...
__decorate([
    ...
    common_1.Post(),
    openapi.ApiResponse({ status: 201, type: require("./dto/mission.dto").MissionDto }),
    __param(0, common_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [mission_body_dto_1.MissionBodyDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, id_decorator_1.Id()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [mission_body_dto_1.MissionBodyDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    common_1.Delete(':id'),
    openapi.ApiResponse({ status: 200, type: require("./dto/delete-mission.dto").DeleteMissionDto }),
    __param(0, token_user_id_decorator_1.TokenUserId()),
    __param(1, id_decorator_1.Id()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
