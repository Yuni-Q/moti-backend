...
let SigninController = class SigninController {
    ...
    async signin(token, body) {
        try {
            ...
            const newUser = user ? user : await this.usersService.createUser({ snsId, snsType, email });
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./dto/signin-response.dto").SigninResponseDto }),
...
SigninController = __decorate([
    ...
    __metadata("design:paramtypes", [signin_service_1.SigninService, users_service_1.UsersService])
], SigninController);
