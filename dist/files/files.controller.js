...
const file_body_dto_1 = require("./dto/file-body.dto");
...
__decorate([
    swagger_1.ApiResponse({
        ...
        type: files_dto_1.FilesDto,
        description: '성공',
    }),
    common_1.Get(),
    openapi.ApiResponse({ status: 200, type: require("./dto/files.dto").FilesDto }),
...
__decorate([
    ...
    common_1.Post(),
    openapi.ApiResponse({ status: 201, type: require("./dto/file.dto").FileDto }),
    __param(0, image_uploade_live_name_decorator_1.ImageUploaderLiveName()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [file_body_dto_1.FileBodyDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    common_1.Put(':id/svg'),
    openapi.ApiResponse({ status: 200, type: require("./dto/file.dto").FileDto }),
    __param(0, image_uploade_live_name_decorator_1.ImageUploaderLiveName()),
    __param(1, id_decorator_1.Id()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [file_body_dto_1.FileBodyDto, Number]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    common_1.Delete(':id'),
    openapi.ApiResponse({ status: 200, type: require("./dto/delete-file.dto").DeleteFileDto }),
